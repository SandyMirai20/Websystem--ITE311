...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="<?= base_url('teacher/courses/' . $course['id']) ?>" class="btn btn-outline-secondary">
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body">
            ...
            <form method="post" action="<?= base_url('teacher/course/' . $course['id'] . '/upload') ?>" enctype="multipart/form-data">
                <?= csrf_field() ?>
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="<?= base_url('teacher/courses/' . $course['id']) ?>" class="btn btn-light">Cancel</a>
                </div>
            </form>
        </div>
    </div>
